...
class OtherForecastVC: UIViewController {
...
extension OtherForecastVC: UITableViewDelegate, UITableViewDataSource {
...
extension OtherForecastVC: CLLocationManagerDelegate {
